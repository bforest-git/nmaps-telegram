...
BOT_TRANSLITERATE_QUERY = 'Чтобы транслитерировать название объекта, отправьте его на русском языке. На данный момент поддерживаются слои дорог, транспорта, гидрографии, растительности и рельефа. Название должно соответствовать [правилам](https://yandex.ru/support/nmaps/attr_name_ru.4.1.html) НЯК.'
BOT_TRANS_CONTINUE = 'Вы можете написать следующий запрос или вернуться в меню.'

BOT_WELCOME_NMAPS = 'Привет, {}!\nРады видеть Вас в чате сервиса Народная карта Яндекса! Здесь Вы можете задать интересующие вопросы и поговорить на любые другие темы, связанные с Народной картой :)\nЧтобы общение в чате проходило в дружелюбной атмосфере и конструктивном ключе, в нашем чате действуют правила: http://telegra.ph/Narodnaya-karta-04-01\nНемножко полезных ссылок: \ntinyurl.com/FAQ-NYK - FAQ Народной карты'
