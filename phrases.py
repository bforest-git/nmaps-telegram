...
BOT_SENT_TO_STAFF = '✅ Направлено сотрудникам (отправил @{})'
BOT_NEW_ROADBLOCK = 'Добрый день. Появилась новая информация о перекрытии.'
BOT_INVESTIGATING = '📋 Выясняет @{}'
BOT_USER_BANNED = '🚫 Пользователь заблокирован (модератор @{})'
